...
- Line    553  components/checkbox/checkbox.props.ts
- Line    613  components/checkbox/checkbox.tokens.ts
- Line    734  components/color-picker/ColorPicker.astro
- Line    755  components/color-picker/color-picker.css
- Line    766  components/color-picker/color-picker.hook.ts
- Line    777  components/color-picker/color-picker.props.ts
- Line    788  components/color-picker/color-picker.tokens.ts
- Line    799  components/combobox/Combobox.astro
- Line   1144  components/combobox/combobox.css
- Line   1345  components/combobox/combobox.hook.ts
- Line   1557  components/combobox/combobox.props.ts
- Line   1638  components/combobox/combobox.tokens.ts
- Line   1719  components/date-picker/DatePicker.astro
- Line   1740  components/date-picker/date-picker.css
- Line   1751  components/date-picker/date-picker.hook.ts
- Line   1762  components/date-picker/date-picker.props.ts
- Line   1773  components/date-picker/date-picker.tokens.ts
- Line   1784  components/field/Field.astro
- Line   1912  components/field/field.css
- Line   2019  components/field/field.hook.ts
- Line   2142  components/field/field.props.ts
- Line   2276  components/field/field.tokens.ts
- Line   2333  components/file-upload/FileUpload.astro
- Line   2354  components/file-upload/file-upload.css
- Line   2365  components/file-upload/file-upload.hook.ts
- Line   2376  components/file-upload/file-upload.props.ts
- Line   2387  components/file-upload/file-upload.tokens.ts
- Line   2398  components/input/Input.astro
- Line   2495  components/input/input.css
- Line   2647  components/input/input.hook.ts
- Line   2858  components/input/input.props.ts
- Line   2967  components/input/input.tokens.ts
- Line   3115  components/input-group/InputGroup.astro
- Line   3136  components/input-group/input-group.css
- Line   3147  components/input-group/input-group.hook.ts
- Line   3158  components/input-group/input-group.props.ts
- Line   3169  components/input-group/input-group.tokens.ts
- Line   3180  components/multiselect/Multiselect.astro
- Line   3201  components/multiselect/multiselect.css
- Line   3212  components/multiselect/multiselect.hook.ts
- Line   3223  components/multiselect/multiselect.props.ts
- Line   3234  components/multiselect/multiselect.tokens.ts
- Line   3245  components/number-input/NumberInput.astro
- Line   3266  components/number-input/number-input.css
- Line   3277  components/number-input/number-input.hook.ts
- Line   3288  components/number-input/number-input.props.ts
- Line   3299  components/number-input/number-input.tokens.ts
- Line   3310  components/radio/Radio.astro
- Line   3404  components/radio/radio.css
- Line   3563  components/radio/radio.hook.ts
- Line   3674  components/radio/radio.props.ts
- Line   3755  components/radio/radio.tokens.ts
- Line   3863  components/radio-group/RadioGroup.astro
- Line   3946  components/radio-group/radio-group.css
- Line   4016  components/radio-group/radio-group.hook.ts
- Line   4066  components/radio-group/radio-group.props.ts
- Line   4099  components/radio-group/radio-group.tokens.ts
- Line   4133  components/range-slider/RangeSlider.astro
- Line   4154  components/range-slider/range-slider.css
- Line   4165  components/range-slider/range-slider.hook.ts
- Line   4176  components/range-slider/range-slider.props.ts
- Line   4187  components/range-slider/range-slider.tokens.ts
- Line   4198  components/search/Search.astro
- Line   4356  components/search/search.css
- Line   4552  components/search/search.hook.ts
- Line   4685  components/search/search.props.ts
- Line   4745  components/search/search.tokens.ts
- Line   4827  components/select/Select.astro
- Line   4972  components/select/select.css
- Line   5118  components/select/select.hook.ts
- Line   5389  components/select/select.props.ts
- Line   5594  components/select/select.tokens.ts
- Line   5702  components/slider/Slider.astro
- Line   5723  components/slider/slider.css
- Line   5734  components/slider/slider.hook.ts
- Line   5745  components/slider/slider.props.ts
- Line   5756  components/slider/slider.tokens.ts
- Line   5767  components/switch/Switch.astro
- Line   5841  components/switch/switch.css
- Line   5982  components/switch/switch.hook.ts
- Line   6052  components/switch/switch.props.ts
- Line   6083  components/switch/switch.tokens.ts
- Line   6135  components/textarea/Textarea.astro
- Line   6195  components/textarea/textarea.css
- Line   6297  components/textarea/textarea.hook.ts
- Line   6380  components/textarea/textarea.props.ts
- Line   6416  components/textarea/textarea.tokens.ts
- Line   6475  components/time-picker/TimePicker.astro
- Line   6496  components/time-picker/time-picker.css
- Line   6507  components/time-picker/time-picker.hook.ts
- Line   6518  components/time-picker/time-picker.props.ts
- Line   6529  components/time-picker/time-picker.tokens.ts
- Line   6540  forms.css
- Line   6733  forms.hook.ts
- Line   6990  forms.props.ts
- Line   7275  forms.tokens.ts
...
.form--outlined:focus-within {
  border-color: var(--form--color-border, var(--primary--border));
  box-shadow: 0 0 0 3px color-mix(in oklch, var(--form--color-base, var(--primary--base)) 20%, transparent);
}
...
.form[data-invalid] {
  ...
  /* overrides all variant border states */
}

.form[data-invalid]:focus-within {
  border-color: var(--danger--border);
  box-shadow: 0 0 0 3px color-mix(in oklch, var(--danger--base) 20%, transparent);
}
