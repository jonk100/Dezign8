...
- Line     63  command-palette/CommandPalette.astro
- Line     84  command-palette/CommandPalette.css
- Line    274  command-palette/CommandPalette.svg
- Line    291  command-palette/CommandPaletteRegion.astro
- Line    573  command-palette/command-palette.md
- Line    757  command-palette/command-palette.svg
- Line    768  command-palette/commandPalette.ts
- Line    818  context-menu/ContextMenu.astro
- Line    999  context-menu/ContextMenu.css
- Line   1070  context-menu/ContextMenu.svg
- Line   1087  context-menu/actions.ts
- Line   1124  context-menu/context-menu.md
- Line   1284  context-menu/context-menu.svg
- Line   1295  context-menu/contextMenu.ts
- Line   1334  drawer/Drawer.astro
- Line   1507  drawer/Drawer.css
- Line   1708  drawer/Drawer.svg
- Line   1724  drawer/drawer.md
- Line   1864  drawer/drawer.svg
- Line   1875  drawer/drawer.ts
- Line   1912  dropdown-menu/DropdownMenu.astro
- Line   2058  dropdown-menu/DropdownMenu.css
- Line   2190  dropdown-menu/DropdownMenu.svg
- Line   2206  dropdown-menu/dropdown-menu.md
- Line   2314  dropdown-menu/dropdown-menu.svg
- Line   2325  modal/Modal.astro
- Line   2486  modal/Modal.css
- Line   2660  modal/Modal.svg
- Line   2676  modal/modal.md
- Line   2824  modal/modal.svg
- Line   2835  modal/modal.ts
- Line   2872  overlays.consts.ts
- Line   3035  overlays.css
- Line   3127  overlays.functions.ts
- Line   3448  overlays.maps.ts
- Line   3707  overlays.md
- Line   3843  overlays.types.ts
- Line   4022  popover/Popover.astro
- Line   4190  popover/Popover.css
- Line   4255  popover/Popover.svg
- Line   4271  popover/popover.md
- Line   4391  popover/popover.svg
- Line   4402  sheet/Sheet.astro
- Line   4442  sheet/Sheet.css
- Line   4455  sheet/Sheet.svg
- Line   4471  sheet/sheet.md
- Line   4578  sheet/sheet.svg
- Line   4589  tokens.css
- Line   4624  tooltip/Tooltip.astro
- Line   4695  tooltip/Tooltip.css
- Line   4825  tooltip/Tooltip.svg
- Line   4841  tooltip/tooltip.md
- Line   4933  tooltip/tooltip.svg
- Line   4944  vars.css

## command-palette/CommandPalette.astro component


**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/command-palette/CommandPalette.astro`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/command-palette/CommandPalette.css`


```css
/* src/design/overlays/command-palette/CommandPalette.css */
...
.command-palette-region {
  ...
  transition:
    opacity var(--overlay-transition-normal) var(--te-out),
    transform var(--overlay-transition-normal) var(--te-out),
    display var(--overlay-transition-normal) var(--te-out) allow-discrete;
  
}

.command-palette-region[open] {
  opacity: 1;
  transform: scale(1);
}

.command-palette-region::backdrop {
...
.command-palette-region[open]::backdrop {
  opacity: 1;
}
...
.command-palette__search-wrapper {
  ...
  border-bottom: 1px solid var(--border-layer--3);
}
...
.command-palette__results {
  /* max-height: var(--overlay-cmd-max-height, 330px); */
  /* overflow-y: auto; */
  padding: var(--sp-xs);
}
...
.command-palette__group-header {
  ...
  letter-spacing: calc(var(--ls-2xs) + 0.05em);
  ...
  text-decoration-color: var(--overlay-text-subtle);
  text-decoration-style: wavy;
}

.command-palette__group-header:first-child {
  margin-top: 0;
}
...
.command-palette__item {
  ...
  padding: var(--sp-2xs);
  font-size: var(--fs-xs);
  border-radius: var(--overlay-radius-inner);
  cursor: pointer;
...
.command-palette__item.is-selected .command-palette__item-label {
...
## command-palette/CommandPalette.svg


**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/command-palette/CommandPalette.svg`
...
## command-palette/CommandPaletteRegion.astro component


**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/command-palette/CommandPaletteRegion.astro`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/command-palette/command-palette.md`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/command-palette/command-palette.svg`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/command-palette/commandPalette.ts`
...
## context-menu/ContextMenu.astro component


**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/context-menu/ContextMenu.astro`
...
## context-menu/ContextMenu.css


**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/context-menu/ContextMenu.css`


```css
/* src/design/overlays/context-menu/ContextMenu.css */
...
.context-menu-region {
  ...
  min-width: 160px;
  box-sizing: border-box;
  z-index: var(--overlay-z-tooltip, 1500) !important;
  animation: overlay-fade-in var(--overlay-transition-fast) var(--te-out);
}
...
.context-menu__divider {
  height: 1px;
  background-color: var(--border-layer--3);
  margin: var(--sp-xs) 0;
}
...
## context-menu/ContextMenu.svg


**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/context-menu/ContextMenu.svg`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/context-menu/actions.ts`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/context-menu/context-menu.md`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/context-menu/context-menu.svg`
...
## context-menu/contextMenu.ts


**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/context-menu/contextMenu.ts`
...
## drawer/Drawer.astro component


**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/drawer/Drawer.astro`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/drawer/Drawer.css`


```css
/* src/design/overlays/drawer/Drawer.css */
...
.drawer-component[open]::backdrop {
  opacity: 1;
}

/* Slide direction alignments */
.drawer-left {
  top: 0;
  left: 0;
  bottom: 0;
...
@starting-style {
  .drawer-component[open].drawer-left {
    transform: translateX(-100%);
  }
  .drawer-component[open].drawer-right {
    transform: translateX(100%);
  }
  .drawer-component[open].drawer-top {
    transform: translateY(-100%);
  }
  .drawer-component[open].drawer-bottom {
    transform: translateY(100%);
  }
  .drawer-component[open]::backdrop {
    opacity: 0;
...
.drawer__actions {
  ...
  gap: var(--sp-xs);
  padding: var(--sp-md) var(--sp-lg);
  border-top: 1px solid var(--border-layer--3);
  background-color: var(--layer--1);
}

/* ============================================================================
   SIZE VARIANT CLASSES (Width for Left/Right, Height for Top/Bottom)
   ============================================================================ */

/* Left/Right Widths */
.drawer-left.overlay-xs, .drawer-right.overlay-xs { width: min(300px, 90vw); }
.drawer-left.overlay-sm, .drawer-right.overlay-sm { width: min(360px, 90vw); }
.drawer-left.overlay-md, .drawer-right.overlay-md { width: min(440px, 90vw); }
.drawer-left.overlay-lg, .drawer-right.overlay-lg { width: min(600px, 90vw); }
.drawer-left.overlay-xl, .drawer-right.overlay-xl { width: min(800px, 90vw); }
.drawer-left.overlay-full, .drawer-right.overlay-full { width: 100vw; }

/* Top/Bottom Heights */
.drawer-top.overlay-xs, .drawer-bottom.overlay-xs { height: 240px; }
.drawer-top.overlay-sm, .drawer-bottom.overlay-sm { height: 300px; }
.drawer-top.overlay-md, .drawer-bottom.overlay-md { height: 380px; }
.drawer-top.overlay-lg, .drawer-bottom.overlay-lg { height: 500px; }
.drawer-top.overlay-xl, .drawer-bottom.overlay-xl { height: 70vh; }
.drawer-top.overlay-full, .drawer-bottom.overlay-full { height: 100vh; }

/* Non-blocking sheet override */
.drawer--no-backdrop {
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/drawer/Drawer.svg`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/drawer/drawer.md`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/drawer/drawer.ts`
...
## dropdown-menu/DropdownMenu.astro component


**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/dropdown-menu/DropdownMenu.astro`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/dropdown-menu/DropdownMenu.css`


```css
/* src/design/overlays/dropdown-menu/DropdownMenu.css */
...
.dropdown-menu__caret {
  transition: transform var(--overlay-transition-fast) var(--te-out);
}

.dropdown-menu-component[open] .dropdown-menu__caret {
...
/* Position modifiers */
.dropdown--bottom-start .dropdown-menu__content {
  top: 100%;
  left: 0;
  margin-top: 4px;
}

.dropdown--bottom-end .dropdown-menu__content {
  top: 100%;
  right: 0;
  margin-top: 4px;
}

.dropdown--top-start .dropdown-menu__content {
  bottom: 100%;
  left: 0;
  margin-bottom: 4px;
}

.dropdown--top-end .dropdown-menu__content {
  bottom: 100%;
  right: 0;
  margin-bottom: 4px;
}

/* Styled items inside details menu */
.dropdown-menu__content a,
.dropdown-menu__content button {
  display: flex;
  align-items: center;
  width: 100%;
  padding: var(--sp-xs) var(--sp-sm);
...
.dropdown-menu__content button:hover {
  background-color: var(--overlay-bg-hover);
  color: var(--color-gold);
}

.dropdown-menu__content .dropdown-divider {
  height: 1px;
  background-color: var(--border-layer--3);
  margin: var(--sp-xs) 0;
}
...
## dropdown-menu/DropdownMenu.svg


**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/dropdown-menu/DropdownMenu.svg`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/dropdown-menu/dropdown-menu.md`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/dropdown-menu/dropdown-menu.svg`
...
## modal/Modal.astro component


**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/modal/Modal.astro`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/modal/Modal.css`


```css
/* src/design/overlays/modal/Modal.css */
...
/* Open states using native open attribute */
.modal-component[open] {
  opacity: 1;
  transform: scale(1);
}

/* Backdrop styles with glassmorphism blur effect */
...
/* ============================================================================
   SIZE VARIANT CLASSES (Mapped from OVERLAY_SIZE_CLASS_MAP)
   ============================================================================ */
.overlay-xs   { width: min(var(--overlay-xs-width, 320px), 95vw); }
.overlay-sm   { width: min(var(--overlay-sm-width, 480px), 95vw); }
.modal-component.overlay-md   { width: min(var(--overlay-md-width, 600px), 95vw); }
.overlay-lg   { width: min(var(--overlay-lg-width, 800px), 95vw); }
.overlay-xl   { width: min(var(--overlay-xl-width, 1140px), 95vw); }
.overlay-full {
  width: 100vw;
  height: 100vh;
  max-width: 100vw;
...
.overlay-full .modal__card {
  max-height: 100vh;
  height: 100%;
}

/* ============================================================================
   PLACEMENT VARIANT CLASSES (Mapped from MODAL_VARIANT_CLASS_MAP)
   ============================================================================ */
.modal-default {
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/modal/Modal.svg`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/modal/modal.md`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/modal/modal.ts`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/overlays.consts.ts`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/overlays.css`
...
/* ============================================================================
   KEYFRAMES FOR ENTRY/EXIT TRANSITIONS
   ============================================================================ */
...
/* ============================================================================
   ...
   ============================================================================ */
.overlay-backdrop-base {
  background: var(--overlay-backdrop-bg);
  backdrop-filter: var(--overlay-backdrop-blur);
  transition: all var(--overlay-transition-normal) var(--te-out);
}

/* ============================================================================
   Z-INDEX LAYERING CLASSES
   ============================================================================ */
.z-dropdown { z-index: var(--overlay-z-dropdown); }
.z-sticky   { z-index: var(--overlay-z-sticky); }
.z-fixed    { z-index: var(--overlay-z-fixed); }
.z-modal    { z-index: var(--overlay-z-modal); }
.z-popover  { z-index: var(--overlay-z-popover); }
.z-tooltip  { z-index: var(--overlay-z-tooltip); }

```


## overlays.functions.ts


**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/overlays.functions.ts`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/overlays.maps.ts`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/overlays.md`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/overlays.types.ts`
...
## popover/Popover.astro component


**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/popover/Popover.astro`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/popover/Popover.css`


```css
/* src/design/overlays/popover/Popover.css */
...
.popover-component {
  ...
  box-shadow: var(--overlay-shadow);
  box-sizing: border-box;
  margin: auto; /* center viewport fallback */
  outline: none;
...
.popover-component:popover-open {
  opacity: 1;
...
/* Position modifiers (when manual placement is overridden on container) */
.popover--top {
  margin-bottom: auto;
}
.popover--bottom {
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/popover/Popover.svg`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/popover/popover.md`
...
## sheet/Sheet.astro component


**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/sheet/Sheet.astro`
...
/**
 * src/design/overlays/sheet/Sheet.astro
 * A declarative Sheet component.
 * - A wrapper around the Drawer component that forces backdrop={false}.
 * - Slides in from any side (left, right, top, bottom) without blocking page interactions.
 * @props (local): id, title, side, size, closeOnBackdrop
 * @props (global): class, class:list, style, animate
 */

import Drawer from "../drawer/Drawer.astro";
import type { Props as DrawerProps } from "../drawer/Drawer.astro";

export interface Props extends Omit<DrawerProps, "backdrop"> {}
...
```astro
<Drawer id={id} {...rest} backdrop={false}>
  <slot />
  {Astro.slots.has("actions") && (
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/sheet/Sheet.css`


```css
/* src/design/overlays/sheet/Sheet.css */
/* Styles are inherited from Drawer.css since Sheet wraps Drawer */
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/sheet/Sheet.svg`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/sheet/sheet.md`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/tokens.css`
...
:root {
  /* ─── BACKDROP TOKENS ────────────────────────────────── */
  --overlay-backdrop-bg: rgba(8, 9, 12, 0.7);
  --overlay-backdrop-blur: blur(12px) saturate(190%);

  /* ─── VISUAL DESIGN TOKENS ───────────────────────────── */
  --overlay-shadow: var(--sh-xl);
  --overlay-bg: var(--layer--2);
  --overlay-bg-hover: var(--layer--3);
  --overlay-border: var(--border-layer--2);
  --overlay-text-primary: var(--text--5);
  --overlay-text-muted: var(--text--d);
  --overlay-text-subtle: var(--text--m);

  /* ─── LAYERING / Z-INDEX TOKENS ──────────────────────── */
  --overlay-z-dropdown: var(--z-dropdown);
  --overlay-z-sticky: var(--z-sticky);
  --overlay-z-fixed: var(--z-overlay);
  --overlay-z-modal: var(--z-modal);
  --overlay-z-popover: var(--z-modal);
  --overlay-z-tooltip: var(--z-tooltip);
}

```


## tooltip/Tooltip.astro component


**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/tooltip/Tooltip.astro`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/tooltip/Tooltip.css`


```css
/* src/design/overlays/tooltip/Tooltip.css */
...
.tooltip-bubble {
  position: absolute;
  background-color: var(--layer--4); /* Sleek light bubble against dark theme */
  ...
  opacity: 0;
  visibility: hidden;
  z-index: var(--overlay-z-tooltip);
  transition:
    opacity var(--overlay-transition-fast) var(--te-out),
    visibility var(--overlay-transition-fast) var(--te-out),
    transform var(--overlay-transition-fast) var(--te-out);
...
.tooltip--top .tooltip-bubble::after {
  ...
  border-color: var(--neutral-15) transparent transparent transparent;
}
...
.tooltip--bottom .tooltip-bubble::after {
  ...
  left: 50%;
  transform: translateX(-50%);
  border-color: transparent transparent var(--neutral-15) transparent;
}
.tooltip--bottom:hover .tooltip-bubble,
.tooltip--bottom:focus-within .tooltip-bubble {
  transform: translate(-50%, 12px);
}
...
.tooltip--left .tooltip-bubble::after {
  ...
  border-color: transparent transparent transparent var(--neutral-15);
}
.tooltip--left:hover .tooltip-bubble,
.tooltip--left:focus-within .tooltip-bubble {
...
.tooltip--right .tooltip-bubble::after {
  ...
  top: 50%;
  transform: translateY(-50%);
  border-color: transparent var(--neutral-15) transparent transparent;
}
.tooltip--right:hover .tooltip-bubble,
.tooltip--right:focus-within .tooltip-bubble {
  transform: translate(12px, -50%);
}
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/tooltip/Tooltip.svg`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/tooltip/tooltip.md`
...
**Full path:** `/home/jk/Code/DesignSystem/src/design/overlays/vars.css`


```css
:root {
  /* ─── OVERLAYS TRANSITION TIMINGS ────────────────────── */
  --overlay-transition-fast: 150ms;
  --overlay-transition-normal: 300ms;
  --overlay-transition-slow: 500ms;

  /* ─── DRAWER & SHEET DIMENSIONS ──────────────────────── */
  --overlay-drawer-width: min(400px, 90vw);
  --overlay-drawer-height: 320px;
  --overlay-sheet-width: min(500px, 95vw);

  /* ─── COMMAND PALETTE DIMENSIONS ─────────────────────── */
  --overlay-cmd-width: min(640px, 95vw);
  --overlay-cmd-max-height: min(450px, 75vh);

  /* ─── POPUP OVERLAYS RADII ───────────────────────────── */
  --overlay-radius: var(--rad-lg);
  --overlay-radius-inner: var(--rad-md);
}
